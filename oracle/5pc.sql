...
>>>>>>> edb72926c8105351f966ce900b1a37486a27d5d8:5pcCopy.sql
--------------------------------------------------------
--------------------------------------------------------
...
select * from board where writer = 'admindayoung';
select * from member;
...
select * from member;
select * from board where board_category in ('qna', 'reply');
desc board;
...
select * from board
where board_category in('reply', 'qna');

desc board;

ALTER TABLE board ADD new_board_pw VARCHAR2(10);
UPDATE board SET new_board_pw = TO_CHAR(board_pw);
ALTER TABLE board DROP COLUMN board_pw;
ALTER TABLE board RENAME COLUMN new_board_pw TO board_pw;

update board set reply_no = null
where reply_no = 0;
...
Insert into JAVA.SITE_BOOK (BOOK_NO,MEMBER_ID,SITE_NO,MEM_CNT,START_DATE,END_DATE,CAR_NUM,TOTAL_PRICE,REVIEW_FLAG,CANCEL_FLAG,CREATE_DATE)
values (114,'user02',1001,3,'2024/10/10 13:00:00','2024/10/11 10:00:00','대구31 가1712',150000,0,0,to_date('24/10/30','RR/MM/DD'));
=======
